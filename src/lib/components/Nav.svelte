...
class=" menu-item mb-2 hover:bg-dark-grey {$page.path == '/about' ? 'bg-dark-grey' : 'bg-marine'}"
>
	About
</span>
<span
	in:fly={{ delay: 600, duration: 400, x: 500, y: 0, opacity: 1, easing: quintOut }}
	class="menu-item mb-2 hover:bg-dark-grey {$page.path == '/programming' ? 'bg-dark-grey' : 'bg-marine'}"
>
	Programming
</span>
<span
	in:fly={{ delay: 700, duration: 400, x: 500, y: 0, opacity: 1, easing: quintOut }}
	class="menu-item mb-2 hover:bg-dark-grey {$page.path == '/interests' ? 'bg-dark-grey' : 'bg-marine'}"
>
	Interests
</span>

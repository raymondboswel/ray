var t = Object.defineProperty,
	...
	i = (t, e) => {
		for (var r in e || (e = {})) a.call(e, r) && n(t, r, e[r]);
		if (s) for (var r of s(e)) o.call(e, r) && n(t, r, e[r]);
		return t;
	};
import {
	S as l,
...
import { s as I, i as D } from './chunks/paths-803150c5.js';
function V(t) {
	let e, r, s;
	const a = [t[2] || {}];
	var o = t[0][1];
	...
	return (
		o && (e = new o(n(t))),
		{
			...
			l(t) {
				e && E(e.$$.fragment, t), (r = w());
			},
			m(t, a) {
				e && q(e, t, a), m(t, r, a), (s = !0);
			},
			p(t, s) {
				const i = 4 & s ? R(a, [L(t[2] || {})]) : {};
				if ((521 & s && (i.$$scope = { dirty: s, ctx: t }), o !== (o = t[0][1]))) {
					...
					o
						? ((e = new o(n(t))), v(e.$$.fragment), j(e.$$.fragment, 1), q(e, r.parentNode, r))
						: (e = null);
				} else o && e.$set(i);
			},
			i(t) {
		...
		o && (e = new o(n())),
		{
			...
			p(t, s) {
				...
				if (o !== (o = t[0][2])) {
					...
					o
						? ((e = new o(n())), v(e.$$.fragment), j(e.$$.fragment, 1), q(e, r.parentNode, r))
						: (e = null);
				} else o && e.$set(i);
			},
			i(t) {
	...
	return {
		...
		p(t, r) {
			t[0][1]
				? s
					? (s.p(t, r), 1 & r && j(s, 1))
					: ((s = V(t)), s.c(), j(s, 1), s.m(e.parentNode, e))
				: s &&
				  (S(),
				  k(s, 1, 1, () => {
						s = null;
...
function M(t) {
	...
	return {
		...
		p(t, s) {
			t[5] ? (r ? r.p(t, s) : ((r = Y(t)), r.c(), r.m(e, null))) : r && (r.d(1), (r = null));
		},
		d(t) {
			t && f(e), r && r.d();
		}
...
function z(t) {
	...
	function i(t) {
		...
		for (let r = 0; r < o.length; r += 1) e = N(e, o[r]);
		return { props: e };
	}
	n && (e = new n(i(t)));
	let l = t[4] && M(t);
	return {
		...
		l(t) {
			e && E(e.$$.fragment, t), (r = x(t)), l && l.l(t), (s = w());
		},
		m(t, o) {
			e && q(e, t, o), m(t, r, o), l && l.m(t, o), m(t, s, o), (a = !0);
		},
		p(t, [a]) {
			const c = 2 & a ? R(o, [L(t[1] || {})]) : {};
			if ((525 & a && (c.$$scope = { dirty: a, ctx: t }), n !== (n = t[0][0]))) {
				if (e) {
					S();
					const t = e;
					k(t.$$.fragment, 1, 0, () => {
				...
				n
					? ((e = new n(i(t))), v(e.$$.fragment), j(e.$$.fragment, 1), q(e, r.parentNode, r))
					: (e = null);
			} else n && e.$set(c);
			t[4]
				? l
...
function G(t, e, r) {
	let { stores: s } = e,
		...
		{ props_1: i = null } = e,
		{ props_2: l = null } = e;
	P('__svelte__', s), A(s.page.notify);
	let c = !1,
		u = !1,
		h = null;
	return (
		...
		(t.$$set = (t) => {
			'stores' in t && r(7, (s = t.stores)),
				...
				'components' in t && r(0, (o = t.components)),
...
const F = {},
	...
	Q = [
		() =>
			H(() => import('./pages/__layout.svelte-701e65e8.js'), [
		...
		() =>
			H(() => import('./error.svelte-dd536125.js'), [
				'/_app/error.svelte-dd536125.js',
				'/_app/chunks/vendor-bb5405de.js'
			]),
		() =>
			H(() => import('./pages/index.svelte-142d5f44.js'), [
				'/_app/pages/index.svelte-142d5f44.js',
				'/_app/assets/Nav.svelte_svelte&type=style&lang-ef81bc76.css',
				'/_app/chunks/vendor-bb5405de.js'
			]),
		() =>
			H(() => import('./pages/about.svelte-7b0cffc5.js'), [
				'/_app/pages/about.svelte-7b0cffc5.js',
				'/_app/assets/Nav.svelte_svelte&type=style&lang-ef81bc76.css',
				'/_app/chunks/vendor-bb5405de.js'
			])
	],
...
class st {
		...
		(this.renderer = t),
			...
			addEventListener('scroll', () => {
				clearTimeout(s),
					(s = setTimeout(() => {
						const t =
							((s = i({}, history.state || {})), (a = { 'sveltekit:scroll': et() }), e(s, r(a)));
						var s, a;
		...
		addEventListener('touchstart', a),
			...
			addEventListener('click', (t) => {
				...
				history.pushState({}, '', o.href),
					this._navigate(o, n ? et() : null, !1, [], o.hash),
					t.preventDefault();
			}),
	...
	async goto(
		t,
		{ noscroll: e = !1, replaceState: r = !1, keepfocus: s = !1, state: a = {} } = {},
		o
	) {
		const n = new URL(
			t,
		...
		return this.enabled && this.owns(n)
			? (history[r ? 'replaceState' : 'pushState'](a, '', t),
			  this._navigate(n, e ? et() : null, s, o, n.hash))
	...
	async _navigate(t, e, r, s, a) {
		...
		if ('/' !== o.path) {
			...
			((t && 'never' === this.trailing_slash) ||
				(!t && 'always' === this.trailing_slash && !o.path.split('/').pop().includes('.'))) &&
				((o.path = t ? o.path.slice(0, -1) : o.path + '/'),
				history.replaceState({}, '', `${this.base}${o.path}${location.search}`));
		}
		this.renderer.notify({ path: o.path, query: o.query }),
			await this.renderer.update(o, s, !1),
			r || document.body.focus();
		const n = a && document.getElementById(a.slice(1));
		e
			? scrollTo(e.x, e.y)
			: n
...
function ot(t, e) {
	...
	if (n) {
		const t = JSON.parse(n.textContent),
			...
			r = ((t, e) => {
				var r = {};
				for (var n in t) a.call(t, n) && e.indexOf(n) < 0 && (r[n] = t[n]);
				if (null != t && s) for (var n of s(t)) e.indexOf(n) < 0 && o.call(t, n) && (r[n] = t[n]);
				return r;
			})(t, ['body']);
...
class nt {
	constructor({ Root: t, fallback: e, target: r, session: s, host: a }) {
		(this.Root = t),
			...
			(this.stores = { page: at({}), navigating: C(null), session: C(s) }),
			(this.$session = null),
			(this.root = null);
		let o = !1;
	...
	async start({ status: t, error: e, nodes: r, page: s }) {
			...
			for (let o = 0; o < r.length; o += 1) {
				...
				if ((a.push(h), h && h.loaded))
					if (h.loaded.error) {
						...
						(n = h.loaded.status), (l = h.loaded.error);
		...
		l && (o = await this._load_error({ status: n, error: l, path: s.path, query: s.query })),
	...
	async update(t, e, r) {
		...
		const o = a.state.branch[a.state.branch.length - 1];
	...
	async _get_navigation_result(t, e) {
		...
		for (let r = 0; r < t.routes.length; r += 1) {
			...
			const o = await this._load({ route: s, path: t.path, query: t.query }, e);
			if (o) return o;
		}
	...
	async _load_node({ status: t, error: e, module: r, page: s, context: a }) {
		...
		for (const i in s.params)
			Object.defineProperty(n, i, {
				get: () => (o.uses.params.add(i), s.params[i]),
				enumerable: !0
			});
		...
		if (r.load) {
			const { started: c } = this,
				u = {
					...
					get context() {
						return (o.uses.context = !0), i({}, a);
					},
					fetch(t, e) {
						const r = 'string' == typeof t ? t : t.url,
							{ href: a } = new URL(r, new URL(s.path, document.baseURI));
						return o.uses.dependencies.push(a), c ? fetch(t, e) : ot(t, e);
					}
				};
		...
		t: for (let b = 0; b < n.length; b += 1) {
			...
			try {
				...
				if (
					...
					const r = b === n.length - 1;
					if (t && t.loaded) {
						if (
							(t.loaded.error && ((m = t.loaded.status), (y = t.loaded.error)), t.loaded.redirect)
						)
			...
			if (y) {
				...
				return await this._load_error({ status: m, error: y, path: e, query: r });
			}
	...
	async _load_error({ status: t, error: e, path: r, query: s }) {
		const a = { host: this.host, path: r, query: s, params: {} },
			o = await this._load_node({ module: await this.fallback[0], page: a, context: {} }),
			n = [
				o,
				await this._load_node({
					...
					page: a,
					context: o && o.loaded && o.loaded.context
				})
			];
		return await this._get_navigation_result_from_branch({ page: a, branch: n });
	}
}
async function it({
	paths: t,
	...
	const l = a && new st({ base: t.base, routes: Z, trailing_slash: n }),
		c = new nt({ Root: J, fallback: tt, target: e, session: r, host: s });
	D(l),
		I(t),
		i && (await c.start(i)),
		a && l.init(c),
		o && l.goto(location.href, { replaceState: !0 }, []),

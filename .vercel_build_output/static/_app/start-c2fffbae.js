...
import {
	...
	B as N,
	C
} from './chunks/vendor-d3912364.js';
import { s as I } from './chunks/paths-d2152a5c.js';
function D(t) {
	let e, r, s;
	const a = [t[2] || {}];
	var n = t[0][1];
	...
	return (
		n && (e = new n(o(t))),
		{
			...
			p(t, s) {
				...
				if ((521 & s && (i.$$scope = { dirty: s, ctx: t }), n !== (n = t[0][1]))) {
					if (e) {
						L();
						const t = e;
						k(t.$$.fragment, 1, 0, () => {
					...
					n
						? ((e = new n(o(t))), v(e.$$.fragment), j(e.$$.fragment, 1), q(e, r.parentNode, r))
						: (e = null);
				} else n && e.$set(i);
			},
			i(t) {
		...
		n && (e = new n(o())),
		{
			...
			p(t, s) {
				...
				if (n !== (n = t[0][2])) {
					...
					n
						? ((e = new n(o())), v(e.$$.fragment), j(e.$$.fragment, 1), q(e, r.parentNode, r))
						: (e = null);
				} else n && e.$set(i);
			},
			i(t) {
...
function W(t) {
	...
	return {
		...
		p(t, s) {
			t[5] ? (r ? r.p(t, s) : ((r = M(t)), r.c(), r.m(e, null))) : r && (r.d(1), (r = null));
		},
		d(t) {
			t && f(e), r && r.d();
		}
...
function Y(t) {
	...
	return {
		...
		p(t, [a]) {
			...
			if ((525 & a && (c.$$scope = { dirty: a, ctx: t }), o !== (o = t[0][0]))) {
				if (e) {
					L();
					const t = e;
					k(t.$$.fragment, 1, 0, () => {
				...
				o
					? ((e = new o(i(t))), v(e.$$.fragment), j(e.$$.fragment, 1), q(e, r.parentNode, r))
					: (e = null);
			} else o && e.$set(c);
			t[4]
				? l
...
const X = {},
	...
	H = [
		() =>
			F(() => import('./pages/__layout.svelte-515be883.js'), [
				'/_app/pages/__layout.svelte-515be883.js',
				'/_app/assets/pages/__layout.svelte-a76a234b.css',
				'/_app/chunks/vendor-d3912364.js'
			]),
		() =>
			F(() => import('./error.svelte-668e5ea6.js'), [
				'/_app/error.svelte-668e5ea6.js',
				'/_app/chunks/vendor-d3912364.js'
			]),
		() =>
			F(() => import('./pages/index.svelte-9ed0f0f9.js'), [
				'/_app/pages/index.svelte-9ed0f0f9.js',
				'/_app/assets/pages/index.svelte-50211c28.css',
				'/_app/chunks/vendor-d3912364.js',
		...
		(this.renderer = t),
			...
			addEventListener('scroll', () => {
				clearTimeout(s),
					(s = setTimeout(() => {
						const t =
							((s = i({}, history.state || {})), (a = { 'sveltekit:scroll': tt() }), e(s, r(a)));
						var s, a;
		...
		addEventListener('touchstart', a),
			...
			addEventListener('click', (t) => {
				...
				history.pushState({}, '', n.href),
					this._navigate(n, o ? tt() : null, !1, [], n.hash),
					t.preventDefault();
			}),
	...
	async _navigate(t, e, r, s, a) {
		...
		if ('/' !== n.path) {
			...
			((t && 'never' === this.trailing_slash) ||
				(!t && 'always' === this.trailing_slash && !n.path.split('/').pop().includes('.'))) &&
	...
	if (o) {
		const t = JSON.parse(o.textContent),
			...
			r = ((t, e) => {
				...
				if (null != t && s) for (var o of s(t)) e.indexOf(o) < 0 && n.call(t, o) && (r[o] = t[o]);
				return r;
			})(t, ['body']);
...
class nt {
	constructor({ Root: t, fallback: e, target: r, session: s, host: a }) {
		(this.Root = t),
			...
			(this.stores = { page: st({}), navigating: C(null), session: C(s) }),
			(this.$session = null),
			(this.root = null);
		let n = !1;
	...
	async start({ status: t, error: e, nodes: r, page: s }) {
		...
		l && (n = await this._load_error({ status: o, error: l, path: s.path, query: s.query })),
			...
			const { started: c } = this,
				u = {
					...
					fetch(t, e) {
						...
						return n.uses.dependencies.push(a), c ? fetch(t, e) : at(t, e);
					}
				};
...
async function ot({
	...
	const l = a && new rt({ base: t.base, routes: Q, trailing_slash: o }),
		c = new nt({ Root: G, fallback: Z, target: e, session: r, host: s });
	I(t),
		i && (await c.start(i)),
		a && l.init(c),

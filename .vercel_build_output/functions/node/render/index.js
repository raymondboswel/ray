...
function init(settings = default_settings) {
	...
	options = {
		...
		entry: {
			...
			js: [
				'/./_app/start-00bb4d39.js',
				'/./_app/chunks/vendor-bb5405de.js',
				'/./_app/chunks/paths-803150c5.js'
			]
		},
		fetched: void 0,
		floc: false,
...
var manifest = {
	assets: [
		...
		{ file: 'hi2.svg', size: 6811, type: 'image/svg+xml' },
...
var metadata_lookup = {
	'src/routes/__layout.svelte': {
		entry: '/./_app/pages/__layout.svelte-701e65e8.js',
		css: [
			'/./_app/assets/pages/__layout.svelte-46ff60d9.css',
			'/./_app/assets/Nav.svelte_svelte&type=style&lang-ef81bc76.css'
		],
		js: [
			'/./_app/pages/__layout.svelte-701e65e8.js',
			'/./_app/chunks/vendor-bb5405de.js',
			'/./_app/chunks/paths-803150c5.js'
		],
		styles: null
	...
	'.svelte-kit/build/components/error.svelte': {
		entry: '/./_app/error.svelte-dd536125.js',
		css: [],
		js: ['/./_app/error.svelte-dd536125.js', '/./_app/chunks/vendor-bb5405de.js'],
		styles: null
	},
	'src/routes/index.svelte': {
		entry: '/./_app/pages/index.svelte-142d5f44.js',
		css: ['/./_app/assets/Nav.svelte_svelte&type=style&lang-ef81bc76.css'],
		js: ['/./_app/pages/index.svelte-142d5f44.js', '/./_app/chunks/vendor-bb5405de.js'],
		styles: null
	},
	'src/routes/about.svelte': {
		entry: '/./_app/pages/about.svelte-7b0cffc5.js',
		css: ['/./_app/assets/Nav.svelte_svelte&type=style&lang-ef81bc76.css'],
		js: ['/./_app/pages/about.svelte-7b0cffc5.js', '/./_app/chunks/vendor-bb5405de.js'],
		styles: null
	}
};
...
var css = {
	code:
		'.menu-item.svelte-18l9664{border:3px solid #46a29f}span.svelte-18l9664{color:#fff}span.svelte-18l9664{background:#46a29f;border-radius:255px 15px 225px 15px/15px 225px 15px 255px;cursor:pointer;line-height:1.5em;margin-right:4px;padding:1em}',
...
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	return `<article style="${'background-color: #0B0C10'}" class="${'h-full w-full overflow-x-none pt-8 px-12'}"><div class="${'flex justify-between items-center mx-20'}"><div class="${'text-shale text-3xl'}">Hi! I&#39;m Raymond.
		...
		<img alt="${''}" class="${'h-20 w-20 rounded-full border-2 border-shale'}" src="${
		escape2(assets) + '/beer_hat_l.jpg'
	}"></div>

	<section class="${'flex'}"><div class="${'flex-grow'}">${
		slots.default ? slots.default({}) : ``
	}</div>
		<div class="${'font-bold md:flex-col justify-between md:flex hidden mr-16 mt-8'}">${validate_component(
		Nav,
		'Nav'
	).$$render($$result, {}, {}, {})}</div>
		<div class="${'absolute bottom-0 left-0 w-full flex justify-center md:hidden'}">${validate_component(
		Nav,
		'Nav'
...
var About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<section><div class="${'flex-grow flex flex-col '}">${
		showText
			? `<p class="${'mr-4 text-shale'}">${escape2(about1)}</p>

			<p class="${'mr-4 my-2  text-shale'}">${escape2(about2)}</p>
			<p class="${'mr-4  text-shale'}">${escape2(about3)}</p>`
			: ``
	}</div></section>`;
});
